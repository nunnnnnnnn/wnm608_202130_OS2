...
<div class="product-contanier grid">
      ...
      <div class="col-xs-12 col-md-9">
         <form action="product_newarrivals_list.php" method="get" class="hotdog" style="margin-top:1em" >
             ...
             <input type="search" name="s" placeholder="You can Search items here" value="<?= $_GET['s'] ?>">
         </form>
       </div>
      ...
      <div class="col-xs-12 col-md-3">
       <div class="display-flex flex-align-center">
         ...
         <form action="product_newarrivals_list.php" method="get">
            <input type="hidden" name="t" value="search">
            <?php echo "<input type='hidden' name='category' value='$current_category'>" ?>
