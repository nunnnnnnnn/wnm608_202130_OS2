...
// $products = MYSQLIQuery("SELECT * FROM `products` WHERE `category` = 'Sales'   LIMIT 12");
...
<div class="product-contanier grid">
      ...
      <div class="col-xs-12 col-md-9">
         <form action="product_Sales_list.php" method="get" class="hotdog" style="margin-top:1em" >
             ...
             <input type="search" name="s" placeholder="You can Search any items under Sale category here" value="<?= $_GET['s'] ?>">
         </form>
       </div>
      ...
      <div class="col-xs-12 col-md-3">
       <div class="display-flex flex-align-center">
         ...
         <form action="product_Sales_list.php" method="get">
            <input type="hidden" name="t" value="search">
            <?php echo "<input type='hidden' name='category' value='$current_category'>" ?>
   ...
   <div class="attraction-contanier">
      ...
      <div class="col-xs-12 col-md-6">
         <a href="product_Home_list.php" class="product">
            <div class="product-image">
               <img src="img/products/images/sale/R4.png" alt="R4">
            </div>
         </a>
      </div>
      ...
      <div class="col-xs-12 col-md-6">
         <a href="product_Fitness_list.php" class="product">
            <div class="product-image">
               <img src="img/products/images/sale/R5.png" alt="R5">
            </div>
         </a>
      </div>
